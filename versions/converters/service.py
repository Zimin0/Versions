...
from versions.converters.registry import ConvertersRegistry, main_converter_registry
...
def load_converters(module: str) -> None:
    ...
    Use it when custom converters already created
    and must be registers to be used in convertation.
    """
...
def convert_version(
    ...
    for conv_cls in converter_cls_list:
        ...
        except:  # TODO: should be a specific exception? # noqa: E722
            # print(error)
